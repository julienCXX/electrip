      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="index.php"><i class="fa fa-link"></i> <span>Open Street MAP</span></a></li>
            <li><a href="comparateur.php"><i class="fa fa-link"></i> <span>Comparateur</span></a></li>
